...
JustGage = function (config) {
    ...
    if (obj.config.donut === true) {
        ...
        // value
        switch (obj.config.value.toString().length) {
            case 1: case 2: valueFontSize = "27px"; break;
            case 3: valueFontSize = "25px"; break;
            case 4: valueFontSize = "22px"; break;
            case 5: case 6: case 7: valueFontSize = "15px"; break;
            default: valueFontSize = ((widgetH / 6.4) > 16) ? (widgetH / 5.4) : 24; break;
        }
        ...
        if (obj.config.label !== '') {
            ...
            if (obj.config.value.toString().length <= 3) {
                valueY = 50;
            }
            else {
