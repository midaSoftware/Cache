    ...
    var L = function (h) {
        var j = function (e) {
            ...
            fnRowCallback: null, fnServerData: function (e, j, m, k) { k.jqXHR = h.ajax({ url: e, data: j, success: function (e) { e.sError && k.oApi._fnLog(k, 0, e.sError); h(k.oInstance).trigger("xhr", [k, e]); m(e) }, dataType: "json", cache: !1, type: k.sServerMethod, error: function (e, h) { "parsererror" == h && k.oApi._fnLog(k, 0, "DataTables warning: JSON data from server could not be parsed. This is caused by a JSON formatting error.") } }) }, fnServerParams: null, fnStateLoad: function (e) {
                ...
                oPaginate: { sFirst: "ראשון", sLast: "אחרון", sNext: "הבא", sPrevious: "קודם" }, sEmptyTable: "אין מידע זמין בטבלה", sInfo: "מציג _START_ עד _END_ מתוך _TOTAL_ רשומות", sInfoEmpty: "מציג 0 עד 0 מתוך 0 רשומות ", sInfoFiltered: '(סינון מתוך _MAX_ רשומות סה"כ)', sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "הצג _MENU_ רשומות", sLoadingRecords: "טוען...", sProcessing: "מעבד נתונים...", sSearch: "חיפוש:", sUrl: "", sZeroRecords: "לא נמצאו רשומות מתאימות"
