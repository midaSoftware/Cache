...
(function ($, window, document) {
    ...
    */
    $.fn.wizard = function (options) {
        ...
        this.filter('wizardform').removeClass('wizard-enabled').each(function (i) {
            // Form object
            ...
            if (equalized) {
                fieldsets.each(function (i) {
                    ...
                    controlsWrapper.prepend('<div class="wizard-spacer" style="height:20px"></div>');
                });
            }
    ...
    */
    ...
    $.fn.wizard.defaults = {
        ...
        * @var string
        */
        controlsWrapper: '<div class="button-height wizard-controls clearfix"></div>',

        /**
        * Previous button markup - must use class 'wizard-prev'
        * @var string
        */
        controlPrev: '<button type="button" class="button glossy mid-margin-right wizard-prev float-right"><span class="button-icon right-side"><span class="icon-backward"></span></span>הקודם</button>',

        /**
        * Next button markup - must use class 'wizard-next'
        * @var string
        */
        controlNext: '<button type="button" class="button glossy mid-margin-right wizard-next float-left">הבא<span class="button-icon left-side"><span class="icon-forward"></span></span></button>'
    };
